...
public class Door : MonoBehaviour {
	...
	public void PlayAnimation () {
		...
		if (aController.GetBool ("DoorOpen")) //if (aController.GetBool ("DoorOpen")== true) 
		{
			aController.SetBool ("DoorOpen", false);
		}
	
		else if (!aController.GetBool ("DoorOpen")) ////if (aController.GetBool ("DoorOpen")== false) 
		{
			aController.SetBool ("DoorOpen", true);
		}
