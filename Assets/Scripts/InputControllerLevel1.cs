...
public class InputControllerLevel1 : MonoBehaviour {
	...
	void Update () {
		...
		if(Input.GetKeyDown(KeyCode.E)) //Was left mouse button clicked?
		{
			...
			if(Physics.Raycast(ray.origin, ray.direction, out hit, 20 ))// where is starts, what direction its going, what it hits, How far away
			{
